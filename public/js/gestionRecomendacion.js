...
function limpiarRecomendacionUpdate(){
    $('#recomendaciones_d').val('');
     }
...
function cargartablaRecomendaciones(data){
    ...
    $("#tablaRecomendaciones").append(
        "<tr id='fila_cod"+"'>\
        <td style='text-align: justify'>"+ data.descripcionRecomendacion+"</td>\
...
$('#RecoUser_FFinal').change(function () {
   
    if ($('#RecoUser_FInicial').val()<=$('#RecoUser_FFinal').val()) {
        
    }else{
        alert('Seleccione una fecha valida');
        $('#RecoUser_FFinal').val($('#RecoUser_FInicial').val());
    }
...
function cargartablaRecomendacionesUsuarios(data){
    //debugger
      $("#tabla_RecomendacionesUsuarios").append(
          ...
          <td style='text-align: justify'>"+ data.recomendaciones_v2.descripcionRecomendacion+"</td>\
